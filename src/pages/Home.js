    ...
    <div className="isolate bg-white">
      ...
      <div className="px-6 pt-6 lg:px-8">
        <nav className="flex items-center justify-between" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12 font-extrabold">
        ...
        <div className="container mx-auto flex px-5 py-5 items-center justify-center flex-col">
          ...
          <div className="text-center lg:w-2/3 w-full">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Sederhanakan dan Integrasikan Semua Proses Bisnis Anda
            </h1>
            <p className="mb-8 leading-relaxed">
              Platform bisnis untuk operasional lebih produktif & terintegrasi
            </p>
